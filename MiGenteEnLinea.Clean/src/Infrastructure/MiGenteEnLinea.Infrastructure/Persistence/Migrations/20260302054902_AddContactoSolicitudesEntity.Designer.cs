...
namespace MiGenteEnLinea.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260302054902_AddContactoSolicitudesEntity")]
    partial class AddContactoSolicitudesEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MiGenteEnLinea.Domain.Entities.Consultas.ConsultaPerfil", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("EmpleadorUserId", "ContratistaIdentificacion", "FechaConsulta")
                        .HasDatabaseName("IX_ConsultasPerfil_Composite");

                    b.ToTable("ConsultasPerfil", (string)null);
                });

            modelBuilder.Entity("MiGenteEnLinea.Domain.Entities.Contactos.ContactoSolicitud", b =>
                {
                    ...
                    b.Property<string>("ContratistaUserId")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
                    ...
                    b.HasIndex("ContratistaUserId", "EmpleadorId", "Estatus")
                        .HasDatabaseName("IX_ContactoSolicitudes_Contratista_Empleador_Estatus");

                    b.ToTable("ContactoSolicitudes", (string)null);
                });
